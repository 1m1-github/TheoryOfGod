...
function awakenregistry()
    ...
    TOGLearning.newpkg(name="TOGZMQAPIServer", pkgs=["ZMQ", "Serialization", "LoopOS", "TOGZMQ", "TOGLogging"], files=$(files("TOGZMQAPIServer")))
    ...
    TOGLearning.newpkg(name="TOGOctahedron", pkgs=["KernelAbstractions", "LinearAlgebra", "Colors", "FileIO", "ImageIO", "LoopOS", "TOGColor", "TOGXAI", "TOGExist", "TOGPrivacy", "TOGRay", "TOGObserveClient", "TOGGPU"], files=$(files("TOGOctahedron")))
    TOGLearning.newpkg(name="TOGCreateServer", pkgs=["ZMQ", "TOGExist", "TOGZMQAPIServer"], files=$(files("TOGCreateServer")))
    ...
    TOGLearning.newpkg(name="TOGCreateClient", pkgs=["ZMQ", "PNGFiles", "TOGExist", "TOGMatrix", "TOGTypst", "TOGZMQAPIClient", "TOGOctahedron"], files=$(files("TOGCreateClient")))
    ...
    TOGLearning.newpkg(name="TOGOctahedronBrowser", pkgs=["Colors", "LoopOS", "TOGExist", "TOGBroadcastBrowser", "TOGOctahedron", "TOGColor", "TOGMoveOctahedron"], files=$(files("TOGOctahedronBrowser")))
    ...
    TOGLearning.newpkg(name="TOGVisualAnalogToDigitalBrowser", pkgs=["ColorTypes", "FixedPointNumbers", "JSON3", "Base64", "PNGFiles", "LoopOS", "TOGXAI", "TOGBroadcastBrowser"], files=$(files("TOGVisualAnalogToDigitalBrowser")))
