...
function awakenregistry()
    ...
    TOGLearning.newpkg(name="TOGOmega", pkg=["Serialization", "TOGAwaken", "TOGCommunicationServer", "TOGZMQ", "TOGLogging"], file=$(file("TOGOmega")))
    ...
    TOGLearning.newpkg(name="TOGSTT", pkg=["Whisper", "Suppressor"], file=$(file("TOGSTT")))
    TOGLearning.newpkg(name="TOGAudioAnalogToDigitalBrowser", pkg=["HTTP", "LoopOS", "TOGBroadcastBrowser", "TOGSTT"], file=$(file("TOGAudioAnalogToDigitalBrowser")))
    # TOGLearning.newpkg(name="TOGAudioAnalogToDigitalBrowser", pkg=["HTTP", "LoopOS", "TOGBroadcastBrowser", "TOGXAI", "TOGSTT"], file=$(file("TOGAudioAnalogToDigitalBrowser")))
    ...
    # TOGLearning.newpkg(name="TOGgod", pkg=["Pkg", "Serialization", "LoopOS", "TOGAwaken", "TOGCommunicationClient", "TOGOctahedron", "TOGLearning", "TOGObserveClient", "TOGCreateClient", "TOGREPL", "TOGLogging", "TOGBroadcastBrowser", "TOGOctahedronBrowser", "TOGAudioAnalogToDigitalBrowser", "TOGTextToAudioBrowser", "TOGVisualAnalogToDigitalBrowser", "TOGPort", "TOGZMQ"], file=$(file("TOGgod")))
    TOGLearning.newpkg(name="TOGgod", pkg=["Pkg", "Serialization", "LoopOS", "TOGAwaken", "TOGCommunicationClient", "TOGLearning", "TOGLogging", "TOGPort", "TOGZMQ", "TOGBroadcastBrowser", "TOGAudioAnalogToDigitalBrowser"], file=$(file("TOGgod")))
    ...
    TOGLearning.newpkg(name="TOGIntelligenceLocal", pkg=["HTTP", "JSON3", "TOGLogging"], file=$(file("TOGIntelligenceLocal")))
