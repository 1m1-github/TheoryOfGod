...
export LoopOS, TOGLearning, TOGCommunicationClient, TOGAwaken, TOGAdvice, TOGBasicTools, TOGgod, TOGIntelligenceLocal, TOGIntelligence, TOGMessage, TOGBroadcastBrowser
export NAME
...
using TOGAdvice, TOGBasicTools, TOGgod, TOGIntelligenceLocal, TOGIntelligence
using TOGCommunicationClient: TOGMessage
# using TOGColor: RGBA

const NAME = """
Let your name be Janet.
"""
